        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Person data is never shared to anybody else, because no personal data is ever collected Your user id is anonymized, so nobody knows who you are. The only data that we share to othe devices is your health status. For example, healthy, have symptoms, or positive test. This information is used to inform other users if your sick, to keep everybody safe.'),
              const SizedBox(height: 20,),
              ...
              const SizedBox(height: 20,),
              const Text('Thank you for using this app.'),
              const SizedBox(height: 20,),
